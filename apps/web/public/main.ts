...
import { canonTokens } from "../src/design-system/tokens";
...
import "../src/components/canon-home";
...
import "../src/components/canon-help";
import "../src/components/canon-universe-modal";
import "../src/components/canon-app";
...
function applyRoute(
  route: Route,
  options?: NavigateOptions & { skipHistory?: boolean }
) {
